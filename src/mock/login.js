const userMap = {
  admin: {
    ...
    refresh_token:
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..s3X7yKk575bJwxLf7w603TD9EBLF8GB8HVqh44ED1Oc'
  }
};
...
const userInfoMap = {
  ...
  data: {
    user: {
      ...
      openId: null,
      mobile: '',
      picUrl: 'http://www.ocn.com.cn/Upload/userfiles/42%28141%29.jpg',
      statu: 0,
      createTime: null,
      updateTime: null,
      roleList: []
    },
    permissions: ['user_view', 'user_del', 'user_upd', 'user_add'],
    roles: ['ROLE_ADMIN']
  }
};
